        ...
        <div class="col-md-12">
            <div class="card k-card">
              ...
              <div class="card-header">
                  ...
                  <a href="{{ route('tcpdf.printall') }}" class="btn btn-danger btn-sm">Print All Address</a>
                </div>
              </div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                           ...
                           <tr>
                               ...
                               <td>{{ $donor->phone }}</td>
                               <td>{{ $donor->address }}
                                 <span class="badge {{ ($donor->print_count == 0) ? 'badge-danger' : 'badge-success' }}">
                               ...
                               <td>
                                 ...
                                 <a href="{{ route('tcpdf.printall', ['id' => $donor]) }}" class="btn btn-sm btn-success">Print
                                 </a>
                               <a href="{{ route('donors.donardetails', ['donor' => $donor]) }}" class="btn btn-sm btn-danger">
                                  View</a>
                                </td>
