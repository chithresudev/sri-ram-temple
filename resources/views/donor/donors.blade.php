...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
                ...
                <div class="card k-card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <button class="btn btn-green btn-sm" data-target="#importbulkdata" data-toggle="modal"
                                data-backdrop="static">Add Bulk Donors</button>
                            <button class="btn btn-orange btn-sm" data-toggle="modal" data-target="#single_donor"
                                data-backdrop="static">
                                Add Single Donors
                            </button>
                            <button id="print_all" data-url="{{ route('tcpdf.printall') }}"
                                class="btn btn-danger btn-sm">Print All Address</button>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @forelse($donors as $index => $donor)
                                    <tr>
                                        ...
                                        <td>{{ $donor->address }}</td>
                                        <td>
                                            <a href="{{ route('tcpdf.index', ['printdetails' => $donor]) }}"
                                                class="btn btn-sm btn-success">Print
                                            </a>
                                            <a href="{{ route('donors.show', ['donor' => $donor]) }}"
            ...
            {{-- Single data inster --}}
            <div class="modal fade" id="single_donor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                            ...
                            <form class="needs-validation" action="{{ route('donors.store') }}" method="POST">
                                ...
                                <div class="form-row pb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="door_no" id="door_no" required
                                            autofocus>
                                    </div>
                                    <div class="col-md-6">
